        ...
        <div className='col-8 col-md-4'>
          <form>
            ...
            <div className='form-group'>
              ...
              <select
                placeholder='Total No of Subjects'
        ...
        <div className='col-12 col-md-10 col-lg-8 '>
          <form onSubmit={handleSubmit}>
              ...
              ? arr.map((obj, i) => (
                  <div key={i} className='form-group d-flex align-items-center'>
                    ...
                    <input
                      ...
                      required
                      onChange={(e) => handleChange(e, `key_${i}`)}
                      placeholder='Enter subject name'
                      type='name'
                      className='mx-4 form-control text-capitalize'
                    />
                    <input
            ...
            <button
              ...
              style={{ display: `${arr.length ? "inherit" : "none"}` }}>
              Submit
            </button>
          </form>
        </div>
          ...
          {response ? (
            <form>
              <div className='form-group d-flex align-items-center'>
                ...
                <input
                  value={response.maxSubject}
                  disabled
                  className='mx-4 form-control text-capitalize'
                />
                <input
                  value={response.maxMarks}
                  className='text-capitalize form-control mr-4'
                  disabled
                />
              </div>
              <div className='text-capitalize form-group d-flex align-items-center'>
                ...
                <input
                  value={response.minSubject}
                  disabled
                  className='text-capitalize mx-4 form-control'
                />
                <input
                  value={response.minMarks}
                  className='text-capitalize form-control mr-4'
                  disabled
                />
              </div>
